 ...
 */
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT, classes = PriceServiceApplication.class)
public class PriceE2ETest {
     ...
     */
    private void performTest(String applicationDate, double expectedPrice, int expectedPriceList) {
        given()
        ...
        .then()
            ...
            .body("finalPrice", equalTo((float)expectedPrice))
